...
# ui component removed by Colin Rawlings to avoid Gtk dependency
...
# Additional types for tree construction
...
class DotEdge:
    def __init__(self, src_id, dst_id, attrs):
        self.src_id=src_id
        self.dst_id=dst_id
        self.attrs=attrs
...
class DotParser(Parser):
    ...
    def handle_graph(self, attrs):
        print(f"graph: attrs: {attrs}")

    def handle_node(self, id, attrs):
        self.nodes[id.decode('utf-8')] = DotNode(id=id.decode('utf-8'),
                                                 attrs=attrs)

    def handle_edge(self, src_id, dst_id, attrs):
        self.edges.append(DotEdge(src_id=src_id.decode('utf-8'),
